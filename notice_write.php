...
<div class="nt_1" style="font-size:20px">공지사항 작성</div><hr>
<form method=post action="notice_upload.php"  enctype="multipart/form-data">
<div class="nt_5" style="margin-bottom:15px">제목</div><div class="nt_2"><input type=text size=70 name=title required></div>
<div class="nt_6" style="margin-bottom:15px;">메시지</div><div class="nt_7"><textarea name=msg required class="nt_9"></textarea></div>
<div class="nt_7">첨부파일<input type=file name=ufile class="nt_8"></div>
<div class="nt_2"><input type=submit value="올리기"></div>
</form>';
