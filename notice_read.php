		...
		<?php
            ...
            <div class="contents_box">
               <article class="contents">
					...
					mysqli_query($db, "UPDATE p_notice set count=count+1 WHERE num=$_GET[id]");
					$result=mysqli_query($db, "select * from p_notice where num='$_GET[id]'");
...
if($row[id]==$_SESSION[id])
	echo "<a href=notice_remove.php?id={$_GET[id]}>글삭제</a> <a href=notice_rewrite.php?id={$_GET[id]}>글수정</a>";
